  ...
  return (
    <section className='w-full bg-muted flex flex-col items-center justify-center'>
      <div className='w-full container mx-auto py-32 flex flex-col items-center justify-center space-x-8'>
        ...
        <p className='text-base text-muted-foreground max-w-3xl text-center pt-4'>
          Choose an affordable that is packed with the best features for
          engaging your audience, creating customer loyalty and driving sales.
        </p>

        <div className='flex justify-center text-center space-x-4 py-12'>
